...
docker compose -f /var/www/fernetloshorneros/docker-compose.prod.yml stop nginx
...
docker compose -f /var/www/fernetloshorneros/docker-compose.prod.yml up -d nginx
