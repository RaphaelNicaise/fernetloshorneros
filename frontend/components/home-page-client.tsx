      ...
      <div className="relative z-10">
        ...
        <section id="inicio" ref={heroRef} className="relative h-screen overflow-hidden bg-[#0b0a07]">
          ...
          <div className="relative z-10 mx-auto flex h-full w-full max-w-6xl items-center px-4 pt-24 pb-0 sm:pt-28 lg:pt-32">
            ...
            >
              ...
              <m.div style={{ opacity: heroContentOpacity, y: heroContentY }}>
                ...
                <m.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35, duration: 0.6, ease: "easeOut" }} className="mt-8 inline-flex max-w-full items-center gap-3 rounded-full border border-white/12 bg-black/28 px-5 py-3 text-left text-xs uppercase tracking-[0.18em] text-white/78 backdrop-blur-md">
        ...
        <section className="bg-white px-4 pb-16 pt-28 sm:pb-24 sm:pt-32">
          <div className="container mx-auto max-w-6xl">
            <m.div className="mb-14 text-center" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={fadeUp}>
            ...
            <m.div className="mb-16 grid grid-cols-2 gap-x-4 gap-y-8 sm:gap-8 lg:grid-cols-4 lg:gap-6" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} variants={stagger}>
              {[
                ...
                <m.div key={item.title} className="group flex flex-col items-center text-center" variants={fadeUp}>
                  <div className="relative mb-5 h-32 w-32 min-[380px]:h-36 min-[380px]:w-36 min-[460px]:h-44 min-[460px]:w-44 overflow-hidden rounded-full border border-black/8 shadow-lg ring-2 ring-[#AA6F3B]/12 transition-transform duration-500 group-hover:scale-105 group-hover:shadow-xl sm:h-52 sm:w-52 lg:h-60 lg:w-60">
                    <Image src={item.img} alt={item.title} fill sizes="(max-width: 640px) 50vw, 25vw" className="object-cover" />
                  </div>
            ...
            <m.div className="text-center" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={fadeUp}>
        ...
        <section className="relative overflow-hidden bg-[#0b0a07] px-4 py-20 sm:py-28">
          ...
          <div className="container mx-auto max-w-6xl space-y-24">
            <div className="grid items-center gap-10 md:grid-cols-2 md:gap-16">
              <m.div className="group relative" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={slideLeft}>
                ...
                <div className="relative h-[320px] overflow-hidden rounded-2xl shadow-2xl ring-1 ring-[#AA6F3B]/20 sm:h-[420px]">
                  <Image src="/storyfernet.webp" alt="Fernet Los Horneros" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent" />
                </div>
              </m.div>
              <m.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={slideRight}>
            ...
            <div className="grid items-center gap-10 md:grid-cols-2 md:gap-16">
              <m.div className="order-2 md:order-1" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={slideLeft}>
              ...
              <m.div className="group relative order-1 md:order-2" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={slideRight}>
                <div className="absolute -inset-3 rounded-2xl bg-[#AA6F3B]/10 blur-xl transition-all duration-500 group-hover:bg-[#AA6F3B]/20" />
                <div className="relative h-[320px] overflow-hidden rounded-2xl shadow-2xl ring-1 ring-[#AA6F3B]/20 sm:h-[420px]">
                  <Image src="/storyredruello.webp" alt="Familia Redruello" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent" />
                </div>
              </m.div>
            </div>
        ...
        <section id="productos" className="relative overflow-hidden bg-white px-4 pb-16 pt-20 scroll-mt-20 sm:pb-24 sm:pt-24">
          <div className="container mx-auto max-w-6xl">
            <m.div className="mb-12 text-center" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={fadeUp}>
