            ...
            <motion.div className="text-center" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={fadeUp}>
              ...
              <div className="flex flex-col justify-center gap-4 sm:flex-row">
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full border border-black bg-black px-6 py-3 font-semibold text-white transition-all duration-200 hover:border-[#AA6F3B] hover:text-[#AA6F3B] hover:shadow-md hover:scale-105 active:scale-95"
                >
        ...
        <section className="relative overflow-hidden bg-[#0b0a07] px-4 py-20 sm:py-28">
          ...
          <div className="container mx-auto max-w-6xl space-y-24">
            ...
            <div className="mx-auto flex max-w-md items-center gap-4">
              ...
              <img src="/logonuevo.webp" alt="" aria-hidden role="presentation" className="h-10 w-10 object-contain opacity-20 brightness-0 invert" />
              <div className="h-px flex-1 bg-[#AA6F3B]/20" />
            </div>
